...
$codusuario=  $_SESSION["codigo_usuario"];
    ...
    if  (empty($_POST['txtCodigoE'])){$codigoElim=0;}else{$codigoElim=$_POST['txtCodigoE'];}
		...
		alert("La Dependencia ya existe. Ingrese otra dependencia");
                window.location="http://localhost/HansaII/web/dependencias/ABMdependencia.php";
		</script>';
                }else{              
                //se define el Query   
                ...
                $query = '';
                header("Refresh:0; url=http://localhost/HansaII/web/dependencias/ABMdependencia.php");
                }
            }
        //si es Modificar    
